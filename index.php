...
/* ── CHAT (Assistente) ── */
.chat-wrap { display: flex; flex-direction: column; height: calc(100vh - 128px); height: calc(100dvh - 128px); }
...
@media (max-width: 700px) {
  ...
  .modal-inner { padding-bottom: calc(26px + env(safe-area-inset-bottom, 0px)); }
}
...
body.flash-modal-open .flash-mobile-nav { display: none !important; }
</style>
...
<script id="flash-modal-nav-fix-js">
(function(){
  // Enquanto qualquer modal (.modal-overlay) estiver aberto, marca o <body>
  // para esconder o menu fixo de navegação — ele tinha z-index maior que os
  // modais e cobria botões no fim do conteúdo (ex.: "Resetar tudo").
  function syncModalOpenState(){
    const anyOpen = !!document.querySelector('.modal-overlay.open');
    document.body.classList.toggle('flash-modal-open', anyOpen);
  }
  document.querySelectorAll('.modal-overlay').forEach(function(overlay){
    new MutationObserver(syncModalOpenState).observe(overlay, {
